...
docker-compose -f docker-compose.yml up -d ca.org1.example.com ca.org2.example.com ca.org3.example.com ca.org4.example.com orderer.example.com couchdb1 couchdb2 couchdb3 couchdb4 peer0.org1.example.com  peer0.org2.example.com peer0.org3.example.com peer0.org4.example.com cli cli2 cli3 cli4
